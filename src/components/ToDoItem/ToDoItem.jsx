                    ...
                    <div>
                        ...
                        <section className="icons_container">
                            {completed ? (
                                <figure
                                    onClick={() =>
                                        handlerSetComplete(completed, _id)
                                    }
                                    className="uncheck_icon"
                                >
                                    <svg
                                        aria-hidden="true"
                                        focusable="false"
            ...
            <React.Fragment>
                <StyledToDoItem>
                    <div className="active-edit-item">
                        ...
                        <section className="icons_container">
                            <figure className="check_icon"></figure>
                            <section className="options_icon">
