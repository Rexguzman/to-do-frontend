    ...
    return (
        ...
        >
            <StyledElement onClick={ () => setOpen(!open)}>
               <figure>
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="user-circle" role="img" viewBox="0 0 496 512">
            ...
            <StyledElement className={economy}>
                <Link to="/economy">
                    <figure>
                        <svg fill="currentColor" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 496">
